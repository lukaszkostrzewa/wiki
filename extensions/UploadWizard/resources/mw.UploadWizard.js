...
mw.UploadWizard.prototype = {
	stepNames: [ 'tutorial', 'file', 'deeds', 'details', 'map', 'thanks' ],
	...
	createInterface: function() {
		...
		// MAP DIV
		// handler for next button
		$( '#mwe-upwiz-stepdiv-map .mwe-upwiz-button-next')
			.click( function() {
	...
	prepareAndMoveToMap: function() {
		var wizard = this;
		wizard.map = new mw.UploadWizardMap( '#mwe-upwiz-map' );
		wizard.moveToStep( 'map', function() { wizard.map.onLayoutReady(); } );
	},

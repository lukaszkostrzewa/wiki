...
class UploadWizardHooks {
	...
	public static $modules = array(
		...
		'ext.uploadWizard' => array(
			...
			'scripts' => array(
				...
				'resources/mw.UploadWizardMap.js',
			...
			'messages' => array(
				...
				'mwe-upwiz-location-showmap',
				'mwe-upwiz-location-hidemap',
	...
	public static function onSchemaUpdate( /* DatabaseUpdater */ $updater = null ) {
		...
		$updater->addExtensionTable( 'uw_needed_photos', dirname( __FILE__ ) . '/UploadWizard.sql' );
